...
<body class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="#" class="bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700">Sign Up</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-green-700">
                                <p>Short URL: <a href="{{ session('success.data.short_url') }}" class="font-semibold underline" target="_blank">{{ session('success.data.short_url') }}</a></p>
                                ...
                                @if(session('success.data.expires_at'))
                                    <p class="mt-1 text-xs">⏰ Expires: {{ \Carbon\Carbon::parse(session('success.data.expires_at'))->format('M j, Y g:i A') }}</p>
                                @endif
                                
                                <div class="mt-2 space-x-2">
                                    <button onclick="copyToClipboard('{{ session('success.data.short_url') }}')" class="bg-green-600 text-white px-3 py-1 rounded text-xs hover:bg-green-700">
                                        Copy Link
                                    </button>
                                    <a href="{{ url('info/' . session('success.data.short_code')) }}" class="bg-blue-600 text-white px-3 py-1 rounded text-xs hover:bg-blue-700">
                                        View Analytics
                                    </a>
                                </div>
                            </div>
            ...
            <form method="POST" action="{{ route('url.shorten') }}" class="space-y-6">
                ...
                <div class="border-t pt-6">
                    <button type="button" 
                        ...
                        <svg id="advanced-chevron" class="ml-2 h-4 w-4 transform transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="password" 
                                           ...
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <p class="mt-1 text-xs text-gray-500">Visitors will need this password to access the URL</p>
                                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div class="bg-white rounded-lg shadow p-6 text-center">
                <div class="text-3xl font-bold text-purple-600">{{ number_format($stats['total_clicks'] > 0 ? $stats['total_clicks'] / max($stats['total_urls'], 1) : 0, 1) }}</div>
